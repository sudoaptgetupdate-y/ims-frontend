...
export default function AssetPage() {
    ...
    const { 
        ...
        handleFilterChange,
        refreshData
    } = usePaginatedFetch("http://localhost:5001/api/inventory-items", 10, { status: "All", itemType: "ASSET" });
    ...
    const handleDecommission = async (assetId) => {
        try {
            await axios.patch(`http://localhost:5001/api/assets/${assetId}/decommission`, {}, {
                                    ...
                                    <td className="p-2 text-center">
                                        <DropdownMenu>
                                            ...
                                            <DropdownMenuContent align="end">
                                                ...
                                                <DropdownMenuItem 
                                                    onClick={() => navigate('/asset-assignments/new')}
