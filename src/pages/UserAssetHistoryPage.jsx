        ...
        const fetchData = async () => {
            ...
            try {
                ...
                const [historyRes, summaryRes, userRes] = await Promise.all([
                    axios.get(`http://localhost:5001/api/users/${userId}/assets`, { headers: { Authorization: `Bearer ${token}` } }),
                    axios.get(`http://localhost:5001/api/users/${userId}/assets/summary`, { headers: { Authorization: `Bearer ${token}` } }),
