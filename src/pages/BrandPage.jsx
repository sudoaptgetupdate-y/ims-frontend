...
export default function BrandPage() {
    ...
    const { 
        ...
        refreshData 
    } = usePaginatedFetch("http://localhost:5001/api/brands");
    ...
    const handleAddBrand = async (e) => {
        e.preventDefault();
        try {
            await axios.post("http://localhost:5001/api/brands", { name: newBrandName }, { headers: { Authorization: `Bearer ${token}` } });
    ...
    const handleEditBrand = async (e) => {
        ...
        try {
            await axios.put(`http://localhost:5001/api/brands/${editingBrand.id}`, { name: editingBrand.name }, { headers: { Authorization: `Bearer ${token}` } });
